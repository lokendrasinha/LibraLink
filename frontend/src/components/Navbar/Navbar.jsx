...
const Navbar = () => {
  ...
  return (
    <div className='flex bg-zinc-800 text-white px-8 py-4 items-center justify-between'>
      ...
      <div className='nav-links-libralink flex items-center gap-4'>
        ...
        <div className='flex gap-4'>
          <Link to="/LogIn" className='px-4 py-1 border border-blue-500 rounded hover:bg-white hover:text-zinc-800 transition-all duration-300'>LogIn
